...
import { ClipboardPaste, Search, Edit2, ChevronLeft, ChevronRight, Trash2, X } from 'lucide-react';
...
interface RefTextConvertProps {
  onOpenEditor: () => void;
}

export default function RefTextConvert({ onOpenEditor }: RefTextConvertProps) {
        ...
        {isPasteModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div 
              ...
              className="relative bg-white rounded-2xl shadow-xl border border-zinc-200/80 w-full max-w-2xl flex flex-col max-h-[85vh]"
            >
